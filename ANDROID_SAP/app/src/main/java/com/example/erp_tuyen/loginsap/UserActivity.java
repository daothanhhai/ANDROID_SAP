        ...
        @Override
            ...
            if(oPw.trim().equals("")||nPw.trim().equals("")||rnPw.trim().equals("")){
                ...
                try {
                    ...
                    if (conn != null) {
                        int resultSet;
                        //String query = "Update view_user set matkhau='" + HASH.md5(rnPw)  + "' where  matkhau='" + HASH.md5(pw) + "' and tendangnhap='"+un+"'";

                        String query = "Update view_user set matkhau=N'" + rnPw  + "' where  matkhau=N'" + pw + "' and tendangnhap='"+un+"'";
